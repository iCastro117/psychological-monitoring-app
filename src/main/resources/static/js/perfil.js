...
const RIESGO_CONFIG = {
    1: { color: '#16a34a', bgClass: 'bg-green-50',   border: 'border-green-400',  texto: 'text-green-800',  icono: '✅', badge: 'bg-green-100 text-green-800', titulo: 'SIN RIESGO PSICOLÓGICO SIGNIFICATIVO', desc: 'El estado emocional del rescatista se encuentra dentro de los parámetros normales. Puede continuar con sus operaciones.' },
    2: { color: '#2563eb', bgClass: 'bg-blue-50',    border: 'border-blue-400',   texto: 'text-blue-800',   icono: '🔵', badge: 'bg-blue-100 text-blue-800',   titulo: 'RIESGO PSICOLÓGICO BAJO',               desc: 'Se detectan indicadores leves. Se recomienda seguimiento de rutina y actividades de bienestar.' },
    3: { color: '#ca8a04', bgClass: 'bg-yellow-50',  border: 'border-yellow-400', texto: 'text-yellow-800', icono: '⚠️', badge: 'bg-yellow-100 text-yellow-800',titulo: 'RIESGO PSICOLÓGICO MODERADO',            desc: 'Se detectan indicadores de alerta. Es recomendable una evaluación con el psicólogo de la unidad.' },
    4: { color: '#ea580c', bgClass: 'bg-orange-50',  border: 'border-orange-400', texto: 'text-orange-800', icono: '🔴', badge: 'bg-orange-100 text-orange-800',titulo: 'RIESGO PSICOLÓGICO ALTO',                desc: 'Se detectan señales significativas de estrés o trauma. Se requiere atención psicológica a corto plazo.' },
    5: { color: '#dc2626', bgClass: 'bg-red-50',     border: 'border-red-500',    texto: 'text-red-800',    icono: '🚨', badge: 'bg-red-100 text-red-800',     titulo: 'RIESGO PSICOLÓGICO CRÍTICO',             desc: 'Se detectan indicadores severos. Se requiere intervención psicológica inmediata. No recomendado para operaciones.' },
};
...
function renderizarPerfil(e) {
    ...
    document.getElementById('perfilBadge').textContent  = nivel <= 2 ? `Nivel ${nivel}` : `Nivel ${nivel}`;
    ...
    document.getElementById('prediccionIcono').textContent     = cfg.icono;
